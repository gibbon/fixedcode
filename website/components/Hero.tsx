...
const modes = [
  {
    ...
    lines: [
      ...
      { type: "output", text: "\u2713 Generated 47 files in ~3s. Auth, audit, logging, events, tests included." },
  ...
  },
  {
    ...
    lines: [
      ...
      { type: "output", text: "\u2713 Schema valid: ddd/1.0" },
      { type: "output", text: "\u2713 Generated 47 files in 2.3s. Auth, audit, logging, events, tests included." },
