...
node engine/bin/fixedcode.js generate examples/order-service/order-domain.yaml -o /tmp/out

# verify the output matches the spec's expectations
node engine/bin/fixedcode.js verify examples/order-service/order-domain.yaml /tmp/out
