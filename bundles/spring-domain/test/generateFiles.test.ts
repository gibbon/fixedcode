...
describe('generateFiles', () => {
  it('produces correct file paths for all expansion types', () => {
    ...
    // Per command
    expect(paths).toContain(
      'src/main/kotlin/io/example/order/domain/order/commands/CreateOrderCommand.kt',
    );
    expect(paths).toContain(
      'src/main/kotlin/io/example/order/domain/order/commands/UpdateOrderStatusCommand.kt',
    );
    ...
    // Per entity command
    expect(paths).toContain(
      'src/main/kotlin/io/example/order/domain/order/entities/commands/AddLineItemCommand.kt',
    );
