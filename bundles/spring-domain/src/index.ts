  ...
  for (const agg of ctx.aggregates) {
    ...
    files.push(
      { template: 'src/main/kotlin/domain/[aggregate]/Aggregate.kt.hbs',
        output: `${aggPath}/${agg.names.pascal}.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/domain/[aggregate]/AggregateEvents.kt.hbs',
        output: `${aggPath}/${agg.names.pascal}Events.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/application/[aggregate]/AggregateCommandService.kt.hbs',
        output: `src/main/kotlin/${pkg}/application/${agg.names.kebab}/${agg.names.pascal}CommandService.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/application/[aggregate]/AggregateQueryService.kt.hbs',
        output: `src/main/kotlin/${pkg}/application/${agg.names.kebab}/${agg.names.pascal}QueryService.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/api/[aggregate]/AggregateApiDelegateImpl.kt.hbs',
        output: `src/main/kotlin/${pkg}/api/${agg.names.kebab}/${agg.names.pascal}ApiDelegateImpl.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/infrastructure/[aggregate]/AggregateReadRepositoryImpl.kt.hbs',
        output: `src/main/kotlin/${pkg}/infrastructure/${agg.names.kebab}/${agg.names.pascal}ReadRepositoryImpl.kt`, ctx: aggCtx },
      { template: 'src/main/kotlin/infrastructure/[aggregate]/AggregateWriteRepositoryImpl.kt.hbs',
        output: `src/main/kotlin/${pkg}/infrastructure/${agg.names.kebab}/${agg.names.pascal}WriteRepositoryImpl.kt`, ctx: aggCtx },
      { template: 'src/test/kotlin/domain/[aggregate]/AggregateTest.kt.hbs',
        output: `${testPath}/domain/${agg.names.kebab}/${agg.names.pascal}Test.kt`, ctx: aggCtx },
