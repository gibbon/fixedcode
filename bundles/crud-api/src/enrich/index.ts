...
function enrichResource(
  ...
  const endpoints: EndpointContext[] = [
    ...
    {
      method: 'GET',
      path: `/${names.kebab}s${idParam}`,
      handlerName: `get${names.pascal}`,
      hasBody: false,
    },
    {
      method: 'POST',
      path: `/${names.kebab}s`,
      handlerName: `create${names.pascal}`,
      hasBody: true,
    },
    {
      method: 'PUT',
      path: `/${names.kebab}s${idParam}`,
      handlerName: `update${names.pascal}`,
      hasBody: true,
    },
    {
      method: 'DELETE',
      path: `/${names.kebab}s${idParam}`,
      handlerName: `delete${names.pascal}`,
      hasBody: false,
    },
  ];
