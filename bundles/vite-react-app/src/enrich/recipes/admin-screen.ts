...
export interface AdminAggregate {
  ...
  /** kebab-case singular for routes/labels (`order`). */
  nameKebab: string;
  /** PascalCase singular (`Order`). */
  namePascal: string;
  /** camelCase singular (`order`). */
  nameCamel: string;
  /** kebab-case plural (`orders`). */
  namePluralKebab: string;
  /** PascalCase plural (`Orders`). */
  namePluralPascal: string;
  /** camelCase plural (`orders`). */
  namePluralCamel: string;
  /** Path segment used in the API URL — kebab plural (`orders`). */
  apiPath: string;
