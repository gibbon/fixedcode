...
<div class="card text-center !py-3" v-click>
  ...
  <p class="!text-xs opacity-60 mt-1">"I need a workspace service with parties and audit trails"</p>
</div>
...
<div class="card" v-click>
  ...
  <p class="!text-xs opacity-80 mt-2">4+ microservices &middot; 100+ domain entities &middot; 1000+ API endpoints &middot; multiple jurisdictions</p>
</div>
