...
<div class="text-center mt-12" v-click>
  <p class="!text-lg opacity-80">3 currencys &middot; 4+ microservices &middot; 100+ entities &middot; 1000+ endpoints</p>
</div>
...
<div class="card-highlight p-6 mb-6">
  ...
  <div class="grid grid-cols-2 gap-4 !text-sm">
    ...
    <div>
      <p class="opacity-60 mb-1">Currencys</p>
