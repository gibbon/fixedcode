...
fixedcode cfr suggest workspace-domain.yaml        # what's missing?
fixedcode cfr check workspace-domain.yaml build    # is everything wired?
fixedcode cfr report workspace-domain.yaml build   # markdown report
```
