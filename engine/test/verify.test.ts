...
describe('verify with manifest — all files exist', () => {
  it('passes when all manifest files are present on disk', () => {
    ...
    touchFile('src/main/kotlin/com/example/domain/Order.kt');
    touchFile('src/main/kotlin/com/example/application/OrderCommandService.kt');

    writeManifest(
      outputDir,
      makeManifest({
        'src/main/kotlin/com/example/domain/Order.kt': {
          hash: 'aaa',
          bundle: 'spring-domain',
          overwrite: true,
        },
        'src/main/kotlin/com/example/application/OrderCommandService.kt': {
          hash: 'bbb',
          bundle: 'spring-domain',
          overwrite: true,
        },
